...
| Tecnología | Estable actual verificada | Selección del proyecto | Motivo |
| --- | --- | --- | --- |
...
Sprint 2 no añade SDKs de proveedor: usa WebClient y contratos HTTP oficiales detrás de puertos
propios. Esto evita fijar versiones de SDK inexistentes o innecesarias y mantiene Spring AI fuera
del dominio.
